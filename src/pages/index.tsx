  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Experience the future of digital marketing with Instagram Automation - Streamlining your customer engagement, accelerating business growth, and offering comprehensive user management. Register for free and unlock the potential of our tool today."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1504270997636-07ddfbd48945?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxJbnN0YWdyYW0lMjBhdXRvbWF0aW9ufGVufDB8fHx8MTY5NDYwMDMzMHww&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience the future of digital marketing with Instagram Automation - Streamlining your customer engagement, accelerating business growth, and offering comprehensive user management. Register for free and unlock the potential of our tool today.`}
            </Text>
            <Box
            ...
            >
              <Stack direction={{ md: 'row', base: 'column' }} spacing="1.5rem">
                <Card userTypeName="Team Admin" type="team-admin" abilities={appConfig.ownerAbilities} />

                <Card userTypeName="Trial" type="trial" abilities={appConfig.customerAbilities} />
              </Stack>
            </Box>
          </Box>
          <Box pt={4}>
